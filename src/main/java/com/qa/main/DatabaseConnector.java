...
public class DatabaseConnector {
    ...
    public void updateActor(String forename, String surname, int actor_id) throws SQLException {
    	String sql = String.format("update actor set first_name = '%s', last_name = '%s' where actor_id = '%s'", forename, surname, actor_id);
    	statement.executeUpdate(sql);
    }

    public void deleteActor(int actor_id) throws SQLException {
    	String sql = String.format("delete from actor where actor_id = '%s' ", actor_id);
    	statement.executeUpdate(sql);
